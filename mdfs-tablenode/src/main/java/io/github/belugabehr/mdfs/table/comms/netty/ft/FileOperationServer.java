...
import io.github.belugabehr.mdfs.table.IpcProperties;
...
@Service
public class FileOperationServer implements Closeable {

	private static final Logger LOG = LoggerFactory.getLogger(FileOperationServer.class);
	...
	@Autowired
	private FileOperationServerInitializer initializer;
